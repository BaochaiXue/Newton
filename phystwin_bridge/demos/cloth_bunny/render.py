...
def render_process_video(model, sim_data, meta, args, device, out_mp4):
    """Compatibility wrapper for the canonical cloth+bunny process renderer."""

    from .offline import render_video as _render_video

    return _render_video(model, sim_data, meta, args, device, out_mp4)
